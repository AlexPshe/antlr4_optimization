...
import sys
from src.antlr4.CommonTokenFactory import CommonTokenFactory
from LexerATNSimulator import LexerATNSimulator
from InputStream import InputStream
from src.antlr4.Recognizer import Recognizer
from Token import Token
from src.antlr4.error.Errors import IllegalStateException, LexerNoViableAltException, RecognitionException
...
class Lexer(Recognizer, TokenSource):
    ...
    def getErrorDisplay(self, str s):
        cdef char c
    ...
    def getErrorDisplayForChar(self, str c):
    ...
    def getCharErrorDisplay(self, str c):
