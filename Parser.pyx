...
from src.antlr4.CommonTokenFactory import TokenFactory
from src.antlr4.error.ErrorStrategy import DefaultErrorStrategy
from InputStream import InputStream
from src.antlr4.Recognizer import Recognizer
from src.antlr4.RuleContext import RuleContext
from src.antlr4.ParserRuleContext import ParserRuleContext
from Token import Token
from Lexer import Lexer
from src.antlr4.atn.ATNDeserializer import ATNDeserializer
from src.antlr4.atn.ATNDeserializationOptions import ATNDeserializationOptions
from src.antlr4.error.Errors import UnsupportedOperationException, RecognitionException
from src.antlr4.tree.ParseTreePatternMatcher import ParseTreePatternMatcher
from src.antlr4.tree.Tree import ParseTreeListener, TerminalNode, ErrorNode
...
class Parser (Recognizer):
    ...
    def enterRecursionRule(self, localctx:ParserRuleContext, int state, int ruleIndex, int precedence):
        self.state = state
    ...
    #
    def pushNewRecursionContext(self, localctx:ParserRuleContext, int state, int ruleIndex):
        previous = self._ctx
    ...
    def getInvokingContext(self, int ruleIndex):
        ctx = self._ctx
    ...
    def precpred(self, localctx:RuleContext , int precedence):
        return precedence >= self._precedenceStack[-1]

    def inContext(self, str context):
    ...
    #
    def isExpectedToken(self, int symbol):
    ...
    def getRuleIndex(self, str ruleName):
        cdef int ruleIndex = self.getRuleIndexMap().get(ruleName, None)
